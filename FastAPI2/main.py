...
@app.get("/news-war/")
def news_war(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
def news_ukraine(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
def news_politics(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-world/")
def news_world(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
def news_ecology(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
def news_insurance(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-covid/")
def news_covid(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-weapon/")
def news_weapon(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
def news_science(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
def news_technology(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-health/")
def news_health(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-kyiv/")
def news_kyiv(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-lviv/")
def news_lviv(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-dnipro/")
def news_dnipro(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-harkov/")
def news_harkov(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
@app.get("/news-odessa/")
def news_odessa(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
...
def news_attractions(request: Request, page: int = Query(1, alias='page', ge=1), page_size: int = Query(6, alias='size', ge=1)):
